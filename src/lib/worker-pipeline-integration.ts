...
export const PARSER_VERSION = "social-security-simple-parser-v1";
export const EVIDENCE_VALIDATOR_VERSION = "evidence-validator-bypassed-v1";
export const VERIFICATION_ENGINE_VERSION = "simple-verification-v1";
